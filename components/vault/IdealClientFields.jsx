 ...
 */
export default function IdealClientFields({ funnelId, onApprove }) {
    ...
    const handleFieldAdded = (newField) => {
        console.log('[IdealClientFields] Custom field added:', newField);
            ...
            <div className="bg-gradient-to-br from-[#1a1a1d] to-[#0e0e0f] border border-[#3a3a3d] rounded-2xl overflow-hidden">
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-white">Ideal Client</h3>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-amber-600 text-white rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50"
                        >
