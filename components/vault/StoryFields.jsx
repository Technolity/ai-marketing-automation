...
export default function StoryFields({ funnelId, onApprove }) {
            ...
            <div className="bg-gradient-to-br from-[#1a1a1d] to-[#0e0e0f] border border-[#3a3a3d] rounded-2xl overflow-hidden">
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${sectionApproved ? 'bg-green-500/20 text-green-400' : 'bg-cyan/20 text-cyan'}`}>
                            {sectionApproved ? <CheckCircle className="w-6 h-6" /> : <BookOpen className="w-6 h-6" />}
                        </div>
                        <div>
                            <h3 className="text-lg font-bold text-white">Signature Story</h3>
                    ...
                    <div className="p-6 pt-0 space-y-6">
                        {isLoading ? (
                            ...
                            <>
                                ...
                                {fields.filter(f => f.is_custom).map((customField) => (
                                    <FieldEditor
                                ...
                                <div className="pt-4 border-t border-[#3a3a3d]">
                                    <CustomFieldAdder sectionId={sectionId} funnelId={funnelId} onFieldAdded={handleFieldAdded} />
                                </div>
                            </>
                        )}
                    </div>
