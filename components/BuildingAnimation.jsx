 ...
 * RESTORED TO EXACT DESIGN of ProcessingAnimation.jsx as requested.
 */
...
export default function BuildingAnimation({
    ...
    totalCount = 13,
    currentSection = "",
    processingMessage: fallbackMessage = "Processing Your Business"
}) {
    // Current display message
    const displayMessage = currentSection || fallbackMessage;
    const percentage = Math.round((completedCount / totalCount) * 100);

    return (
        <AnimatePresence>
            {isGenerating && (
                <div className="fixed inset-0 z-[100] bg-[#0e0e0f] flex items-center justify-center">
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                    ...
                    >
                        {/* Animated Logo/Icon - EXACT ORIGINAL DESIGN */}
                        <motion.div
                        ...
                        {/* Progress indicator - THE ORIGINAL SCANNING BAR */}
                        ...
                        >
                            Building your Phase {completedCount < 6 ? '1' : '2'} marketing system.
