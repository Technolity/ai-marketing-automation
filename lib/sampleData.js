...
export const SAMPLE_DATA = {
    ...
    // 7. Personal Story (Split into 4 parts)
    storyLowMoment: "I was a corporate executive working 80 hours a week until I collapsed from exhaustion at 35. Doctors said I was pre-diabetic with high blood pressure.",
    storyDiscovery: "I spent 5 years biohacking my way back to health, got certified as a health coach, and realized traditional fitness advice fails busy leaders.",
    storyBreakthrough: "I built this system to save others from my fate.",
    storyResults: "Now I've helped 500+ executives transform their health without sacrificing their careers.",
...
export const SAMPLE_DATA_STEP_MAP = {
    ...
    7: {
        storyLowMoment: SAMPLE_DATA.storyLowMoment,
        storyDiscovery: SAMPLE_DATA.storyDiscovery,
        storyBreakthrough: SAMPLE_DATA.storyBreakthrough,
        storyResults: SAMPLE_DATA.storyResults
    },
