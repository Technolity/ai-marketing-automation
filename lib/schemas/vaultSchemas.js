...
export const funnelCopySchema = z.object({
  funnelCopy: z.object({
    optinPage: z.object({
      ...
      mockup_image: z.string().url().optional().describe("Mockup image URL")
    }),
    salesPage: z.object({
      // Hero Section
      ...
      bio_image: z.string().url().optional().describe("Bio image URL"),
      ...
      testimonial_review_1_image: z.string().url().optional().describe("Testimonial 1 image URL"),
      ...
      testimonial_review_2_image: z.string().url().optional().describe("Testimonial 2 image URL"),
      ...
      testimonial_review_3_image: z.string().url().optional().describe("Testimonial 3 image URL"),
      ...
      testimonial_review_4_image: z.string().url().optional().describe("Testimonial 4 image URL"),
      ...
      // Video
      video_link: z.string().url().optional().describe("VSL video URL")
    }),
    ...
    thankYouPage: z.object({
      ...
      video_link: z.string().url().optional().describe("Thank you video URL")
    })
  })
});
