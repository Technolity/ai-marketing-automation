...
export const colorsSchema = z.object({
  colorPalette: z.object({
    primaryColor: colorSchema.describe("Main brand color - most prominent in funnel"),
    secondaryColor: colorSchema.describe("Supporting color - complements primary"),
    accentColor: colorSchema.describe("Accent color - calls-to-action and highlights"),
    reasoning: z.string().min(50).max(500).describe("Why these colors work together for this brand and ideal client")
  })
});
