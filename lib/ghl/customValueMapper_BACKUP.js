...
export function mapSessionToCustomValues(sessionData, generatedImages = []) {
  ...
  const customValues = {
    ...
    // ============================================
    company_name: answers.companyName || (answers.industry ? `${answers.industry} Solutions` : 'Your Business'),
    company_address: answers.companyAddress || 'Contact us for location details',
    company_support_email: answers.supportEmail || 'support@yourbusiness.com',
    company_telephone: answers.telephone || '',
    ...
    Questionnaire_CTA_color: colors.ctaBackground || '#008000',

    // ============================================
    // SURVEY STYLING (from GHL template)
    // ============================================
    survey_next_bg: '#333333',
    survey_next_btn_bg: '#ffffff',
    survey_next_btn_txt: colors.primary || '#0d6efd',

    // ============================================
    // VIDEO URLS (user-configured in GHL)
    // ============================================
    vsl_video_url: answers.vslVideoUrl || '',
    testimonial_video_url: answers.testimonialVideoUrl || '',
    thankyou_video_url: answers.thankyouVideoUrl || '',
    TEst_video: answers.testVideoUrl || '',

    // ============================================
    // ACCESS TOKENS / DATASET (managed externally)
    // ============================================
    Access_Token: answers.accessToken || '',
    Dataset_ID: answers.datasetId || '',

    // ============================================
    // OPTIN EMAIL SEQUENCE - SUBJECTS (1-17)
    // ============================================
    Optin_Email_Subject_1: getNestedValue(emails, 'sequence[0].subject') || '',
    Optin_Email_Subject_2: getNestedValue(emails, 'sequence[1].subject') || '',
    Optin_Email_Subject_3: getNestedValue(emails, 'sequence[2].subject') || '',
    Optin_Email_Subject_4: getNestedValue(emails, 'sequence[3].subject') || '',
    Optin_Email_Subject_5: getNestedValue(emails, 'sequence[4].subject') || '',
    Optin_Email_Subject_6: getNestedValue(emails, 'sequence[5].subject') || '',
    Optin_Email_Subject_7: getNestedValue(emails, 'sequence[6].subject') || '',
    Optin_Email_Subject_8: getNestedValue(emails, 'sequence[7].subject') || '',
    Optin_Email_Subject_9: getNestedValue(emails, 'sequence[8].subject') || '',
    Optin_Email_Subject_10: getNestedValue(emails, 'sequence[9].subject') || '',
    Optin_Email_Subject_11: getNestedValue(emails, 'sequence[10].subject') || '',
    Optin_Email_Subject_12: getNestedValue(emails, 'sequence[11].subject') || '',
    Optin_Email_Subject_13: getNestedValue(emails, 'sequence[12].subject') || '',
    Optin_Email_Subject_14: getNestedValue(emails, 'sequence[13].subject') || '',
    Optin_Email_Subject_15: getNestedValue(emails, 'sequence[14].subject') || '',
    Optin_Email_Subject_16: getNestedValue(emails, 'sequence[15].subject') || '',
    Optin_Email_Subject_17: getNestedValue(emails, 'sequence[16].subject') || '',

    // ============================================
    // OPTIN EMAIL SEQUENCE - BODIES (1-17)
    // ============================================
    Optin_Email_Body_1: getNestedValue(emails, 'sequence[0].body') || '',
    Optin_Email_Body_2: getNestedValue(emails, 'sequence[1].body') || '',
    Optin_Email_Body_3: getNestedValue(emails, 'sequence[2].body') || '',
    Optin_Email_Body_4: getNestedValue(emails, 'sequence[3].body') || '',
    Optin_Email_Body_5: getNestedValue(emails, 'sequence[4].body') || '',
    Optin_Email_Body_6: getNestedValue(emails, 'sequence[5].body') || '',
    Optin_Email_Body_7: getNestedValue(emails, 'sequence[6].body') || '',
    Optin_Email_Body_8: getNestedValue(emails, 'sequence[7].body') || '',
    Optin_Email_Body_9: getNestedValue(emails, 'sequence[8].body') || '',
    Optin_Email_Body_10: getNestedValue(emails, 'sequence[9].body') || '',
    Optin_Email_Body_11: getNestedValue(emails, 'sequence[10].body') || '',
    Optin_Email_Body_12: getNestedValue(emails, 'sequence[11].body') || '',
    Optin_Email_Body_13: getNestedValue(emails, 'sequence[12].body') || '',
    Optin_Email_Body_14: getNestedValue(emails, 'sequence[13].body') || '',
    Optin_Email_Body_15: getNestedValue(emails, 'sequence[14].body') || '',
    Optin_Email_Body_16: getNestedValue(emails, 'sequence[15].body') || '',
    Optin_Email_Body_17: getNestedValue(emails, 'sequence[16].body') || '',

    // ============================================
    // FREE GIFT EMAIL (single email)
    // ============================================
    Free_Gift_Email_Subject: getNestedValue(leadMagnet, 'deliveryEmail.subject') || '',
    Free_Gift_Email_Body: getNestedValue(leadMagnet, 'deliveryEmail.body') || '',
...
export default customValueMapperBACKUP;