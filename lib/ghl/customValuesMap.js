...
export const MEDIA_MAP = {
    ...
    profile_photo: '03_vsl_bio_image',              // Bio / Author Photo
    banner_image: '03_optin_mockup_image',     // Free Gift Image (product mockup)
    vsl_video: '03_vsl_video_link',               // Appointment Booking Video (VSL)
...
export default customValuesMap;