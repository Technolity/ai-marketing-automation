...
export function buildSlotDeployCustomValues({
    ...
    // `vsl_video` is the LIVE Appointment Booking video field_id; main_vsl is legacy.
    // Live first stops a stale legacy row shadowing the current video ("booking video gone").
