...
export function buildSlotDeployCustomValues({
    ...
    addValue(values, prefixedKey('vsl_bio_image'), combinedMedia.bio_author || combinedMedia.bioPhoto || combinedMedia.bio_photo || combinedMedia.profile_photo);
    addValue(values, prefixedKey('optin_mockup_image'), combinedMedia.product_mockup || combinedMedia.mockup || combinedMedia.mockupImage || combinedMedia.optin_mockup);
