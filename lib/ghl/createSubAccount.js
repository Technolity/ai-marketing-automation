...
export async function createGHLSubAccount(userId, userData) {
    ...
    try {
        ...
        // 3. Prepare sub-account data per GHL API spec
        const locationData = {
        ...
        // Note: companyId from env is NOT used in location creation
        // The API uses the agency token context to determine parent agency
