...
export function mapSessionToCustomValues(sessionData) {
  ...
  const customValues = {
    ...
    // Brand Colors - parse or default to Red/Black theme
    brand_color_primary: '#991b1b', // Default Red
    brand_color_secondary: '#000000', // Default Black
    brand_color_accent: '#ffffff', // Default White
