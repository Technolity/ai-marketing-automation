...
export function mapMediaToGHLValues(mediaContent) {
    ...
    if (mediaContent.thankYouVideo || mediaContent.thank_you_video || mediaContent.confirmationVideo) {
        const tyVideoUrl = mediaContent.thankYouVideo || mediaContent.thank_you_video || mediaContent.confirmationVideo;
