...
export function replaceFreeGiftPlaceholder(content, leadMagnetTitle) {
    ...
    if (typeof content === 'string') {
        // Replace all variations of Free Gift placeholder with actual title
        // Matches: [Free Gift], Free Gift Name, [free gift], free gift name, etc.
        return content
            .replace(/\[Free Gift\]/gi, leadMagnetTitle)
            .replace(/\[free gift\]/gi, leadMagnetTitle)
            .replace(/Free Gift Name/gi, leadMagnetTitle)
            .replace(/\bfree gift\b/gi, leadMagnetTitle);
    }
