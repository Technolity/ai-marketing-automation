...
export const VAULT_FIELD_STRUCTURES = {
    ...
    funnelCopy: {
        ...
        fields: [
            // FIELD 1: OPTIN PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'logo_image', field_label: 'Logo Image', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_optin_logo_image' },
                        { field_id: 'mockup_image', field_label: 'Mockup Image', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_optin_mockup_image' },
                        { field_id: 'cta_text', field_label: 'CTA Button Text', field_type: 'text', maxLength: 50, placeholder: 'Get Instant Access', ghl_key: '02_optin_cta_text' },
                        { field_id: 'headline_text', field_label: 'Headline', field_type: 'textarea', rows: 2, maxLength: 150, ghl_key: '02_optin_headline_text' },
                        { field_id: 'subheadline_text', field_label: 'Sub-Headline', field_type: 'textarea', rows: 3, maxLength: 200, ghl_key: '02_optin_subheadline_text' },
                        { field_id: 'footer_company_name', field_label: 'Company Name', field_type: 'text', maxLength: 100, ghl_key: '02_footer_company_name' }
                    ],
            ...
            // FIELD 2: SALES PAGE (VSL)
            {
                ...
                field_metadata: {
                    subfields: [
                        // Hero Section
                        { field_id: 'hero_headline_text', field_label: 'Hero Headline', field_type: 'textarea', rows: 2, maxLength: 150, ghl_key: '02_vsl_hero_headline_text' },
                        { field_id: 'video', field_label: 'VSL Video URL', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_video' },
                        { field_id: 'cta_text', field_label: 'CTA Button Text', field_type: 'text', maxLength: 50, ghl_key: '02_vsl_cta_text' },
                        { field_id: 'acknowledge_pill_text', field_label: 'Acknowledgement Pill', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_acknowledge_pill_text' },

                        // Process Section
                        { field_id: 'process_headline_text', field_label: 'Process Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_process_headline_text' },
                        { field_id: 'process_sub_headline_text', field_label: 'Process Sub-Headline', field_type: 'textarea', rows: 2, maxLength: 150, ghl_key: '02_vsl_process_sub_headline_text' },
                        { field_id: 'process_bullet_1_text', field_label: 'Process Step 1', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_process_bullet_1_text' },
                        { field_id: 'process_bullet_2_text', field_label: 'Process Step 2', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_process_bullet_2_text' },
                        { field_id: 'process_bullet_3_text', field_label: 'Process Step 3', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_process_bullet_3_text' },
                        { field_id: 'process_bullet_4_text', field_label: 'Process Step 4', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_process_bullet_4_text' },
                        { field_id: 'process_bullet_5_text', field_label: 'Process Step 5', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_process_bullet_5_text' },

                        // Audience Callout
                        { field_id: 'audience_callout_headline_text', field_label: 'Audience Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_audience_callout_headline_text' },
                        { field_id: 'audience_callout_bullet_1_text', field_label: 'Audience Bullet 1', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_audience_callout_bullet_1_text' },
                        { field_id: 'audience_callout_bullet_2_text', field_label: 'Audience Bullet 2', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_audience_callout_bullet_2_text' },
                        { field_id: 'audience_callout_bullet_3_text', field_label: 'Audience Bullet 3', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_audience_callout_bullet_3_text' },
                        { field_id: 'audience_callout_cta_text', field_label: 'Audience CTA', field_type: 'text', maxLength: 50, ghl_key: '02_vsl_audience_callout_cta_text' },

                        // Testimonials
                        { field_id: 'testimonials_headline_text', field_label: 'Testimonials Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonials_headline_text' },
                        { field_id: 'testimonials_profile_pic_1', field_label: 'Testimonial Photo 1', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_1' },
                        { field_id: 'testimonials_profile_pic_2', field_label: 'Testimonial Photo 2', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_2' },
                        { field_id: 'testimonials_profile_pic_3', field_label: 'Testimonial Photo 3', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_3' },
                        { field_id: 'testimonials_profile_pic_4', field_label: 'Testimonial Photo 4', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_4' },

                        // Call Details
                        { field_id: 'call_details_headline_text', field_label: 'Call Details Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_call_details_headline_text' },
                        { field_id: 'call_details_is_not_heading', field_label: 'IS NOT Heading', field_type: 'text', maxLength: 50, ghl_key: '02_vsl_call_details_is_not_heading' },
                        { field_id: 'call_details_is_heading', field_label: 'IS Heading', field_type: 'text', maxLength: 50, ghl_key: '02_vsl_call_details_is_heading' },
                        { field_id: 'call_details_is_not_bullet_1_text', field_label: 'IS NOT Bullet 1', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_not_bullet_1_text' },
                        { field_id: 'call_details_is_not_bullet_2_text', field_label: 'IS NOT Bullet 2', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_not_bullet_2_text' },
                        { field_id: 'call_details_is_not_bullet_3_text', field_label: 'IS NOT Bullet 3', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_not_bullet_3_text' },
                        { field_id: 'call_details_is_bullet_1_text', field_label: 'IS Bullet 1', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_bullet_1_text' },
                        { field_id: 'call_details_is_bullet_2_text', field_label: 'IS Bullet 2', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_bullet_2_text' },
                        { field_id: 'call_details_is_bullet_3_text', field_label: 'IS Bullet 3', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_call_details_is_bullet_3_text' },

                        // Bio Section
                        { field_id: 'bio_photo_text', field_label: 'Bio Photo', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_bio_photo_text' },
                        { field_id: 'bio_headline_text', field_label: 'Bio Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_bio_headline_text' },
                        { field_id: 'bio_paragraph_text', field_label: 'Bio Paragraph', field_type: 'textarea', rows: 5, maxLength: 500, ghl_key: '02_vsl_bio_paragraph_text' },

                        // FAQ Section
                        { field_id: 'faq_headline_text', field_label: 'FAQ Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_faq_headline_text' },
                        { field_id: 'faq_question_1_text', field_label: 'FAQ Question 1', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_faq_question_1_text' },
                        { field_id: 'faq_answer_1_text', field_label: 'FAQ Answer 1', field_type: 'textarea', rows: 3, maxLength: 300, ghl_key: '02_vsl_faq_answer_1_text' },
                        { field_id: 'faq_question_2_text', field_label: 'FAQ Question 2', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_faq_question_2_text' },
                        { field_id: 'faq_question_3_text', field_label: 'FAQ Question 3', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_faq_question_3_text' },
                        { field_id: 'faq_question_4_text', field_label: 'FAQ Question 4', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_faq_question_4_text' }
                    ],
            ...
            // FIELD 3: BOOKING PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'logo_image', field_label: 'Logo Image', field_type: 'text', placeholder: 'URL from media library (reused)', ghl_key: '02_optin_logo_image' },
                        { field_id: 'booking_pill_text', field_label: 'Booking Pill Text', field_type: 'text', maxLength: 100, ghl_key: '02_booking_pill_text' },
                        { field_id: 'calendar_embedded_code', field_label: 'Calendar Embed Code', field_type: 'textarea', rows: 5, ghl_key: '03_booking_calendar_embedded_code' },
                        { field_id: 'footer_company_name', field_label: 'Company Name', field_type: 'text', maxLength: 100, placeholder: '(reused)', ghl_key: '02_footer_company_name' }
                    ],
            ...
            // FIELD 4: THANK YOU PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'logo_image', field_label: 'Logo Image', field_type: 'text', placeholder: 'URL from media library (reused)', ghl_key: '02_optin_logo_image' },
                        { field_id: 'headline_text', field_label: 'Headline', field_type: 'textarea', rows: 2, maxLength: 150, ghl_key: '02_thankyou_page_headline_text' },
                        { field_id: 'subheadline_text', field_label: 'Sub-Headline', field_type: 'textarea', rows: 3, maxLength: 200, ghl_key: '02_thankyou_page_subheadline_text' },
                        { field_id: 'video', field_label: 'Video URL', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_thankyou_page_video' },
                        { field_id: 'testimonials_headline_text', field_label: 'Testimonials Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonials_headline_text' },
                        { field_id: 'testimonials_subheadline_text', field_label: 'Testimonials Sub-Headline', field_type: 'text', maxLength: 150, ghl_key: '02_vsl_testimonials_subheadline_text' },
                        { field_id: 'testimonial_review_1_headline', field_label: 'Testimonial 1 Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonial_review_1_headline' },
                        { field_id: 'testimonial_review_1_paragraph_with_name', field_label: 'Testimonial 1 Body + Name', field_type: 'textarea', rows: 3, maxLength: 300, ghl_key: '02_vsl_testimonial_review_1_paragraph_with_name' },
                        { field_id: 'testimonial_review_2_headline', field_label: 'Testimonial 2 Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonial_review_2_headline' },
                        { field_id: 'testimonial_review_2_paragraph_with_name', field_label: 'Testimonial 2 Body + Name', field_type: 'textarea', rows: 3, maxLength: 300, ghl_key: '02_vsl_testimonial_review_2_paragraph_with_name' },
                        { field_id: 'testimonial_review_3_headline', field_label: 'Testimonial 3 Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonial_review_3_headline' },
                        { field_id: 'testimonial_review_3_paragraph_with_name', field_label: 'Testimonial 3 Body + Name', field_type: 'textarea', rows: 3, maxLength: 300, ghl_key: '02_vsl_testimonial_review_3_paragraph_with_name' },
                        { field_id: 'testimonial_review_4_headline', field_label: 'Testimonial 4 Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonial_review_4_headline' },
                        { field_id: 'testimonial_review_4_paragraph_with_name', field_label: 'Testimonial 4 Body + Name', field_type: 'textarea', rows: 3, maxLength: 300, ghl_key: '02_vsl_testimonial_review_4_paragraph_with_name' },
                        { field_id: 'testimonials_profile_pic_1', field_label: 'Testimonial Photo 1', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_1' },
                        { field_id: 'testimonials_profile_pic_2', field_label: 'Testimonial Photo 2', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_2' },
                        { field_id: 'testimonials_profile_pic_3', field_label: 'Testimonial Photo 3', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_3' },
                        { field_id: 'testimonials_profile_pic_4', field_label: 'Testimonial Photo 4', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_4' },
    ...
    media: {
        ...
        fields: [
            ...
            {
                field_id: 'testimonial_1_photo',
                field_label: 'Testimonial Photo 1',
                field_type: 'image',
                field_metadata: {
                    placeholder: 'Upload photo...',
                    hint: 'Photo for first testimonial'
                },
                display_order: 5
            },
            {
                field_id: 'testimonial_2_photo',
                field_label: 'Testimonial Photo 2',
                field_type: 'image',
                field_metadata: {
                    placeholder: 'Upload photo...',
                    hint: 'Photo for second testimonial'
                },
                display_order: 6
            },
            {
                field_id: 'testimonial_3_photo',
                field_label: 'Testimonial Photo 3',
                field_type: 'image',
                field_metadata: {
                    placeholder: 'Upload photo...',
                    hint: 'Photo for third testimonial'
                },
                display_order: 7
            },
            {
                field_id: 'testimonial_4_photo',
                field_label: 'Testimonial Photo 4',
                field_type: 'image',
                field_metadata: {
                    placeholder: 'Upload photo...',
                    hint: 'Photo for fourth testimonial'
                },
                display_order: 8
            }
        ]
