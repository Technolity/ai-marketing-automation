    ...
    funnelCopy: {
        ...
        fields: [
            // FIELD 1: OPTIN PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'logo_image', field_label: 'Logo Image', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_optin_logo_image', group: 'Hero' },
                        { field_id: 'mockup_image', field_label: 'Mockup Image', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_optin_mockup_image', group: 'Hero' },
            ...
            // FIELD 2: SALES PAGE (VSL)
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'video', field_label: 'VSL Video URL', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_video', group: 'Hero' },
                        ...
                        { field_id: 'testimonials_profile_pic_1', field_label: 'Testimonial Photo 1', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_1', group: 'Testimonials' },
                        { field_id: 'testimonials_profile_pic_2', field_label: 'Testimonial Photo 2', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_2', group: 'Testimonials' },
                        { field_id: 'testimonials_profile_pic_3', field_label: 'Testimonial Photo 3', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_3', group: 'Testimonials' },
                        { field_id: 'testimonials_profile_pic_4', field_label: 'Testimonial Photo 4', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_testimonials_profile_pic_4', group: 'Testimonials' },
                        ...
                        // Bio Section
                        { field_id: 'bio_photo_text', field_label: 'Bio Photo', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_vsl_bio_photo_text', group: 'Bio' },
            ...
            // FIELD 3: BOOKING PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'logo_image', field_label: 'Logo Image', field_type: 'text', placeholder: 'URL from media library (reused)', ghl_key: '02_optin_logo_image', group: 'Hero' },
                        ...
                        { field_id: 'calendar_embedded_code', field_label: 'Calendar Embed Code', field_type: 'textarea', rows: 5, ghl_key: '03_booking_calendar_embedded_code', group: 'Process' },
            ...
            // FIELD 4: THANK YOU PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'video', field_label: 'Video URL', field_type: 'text', placeholder: 'URL from media library', ghl_key: '02_thankyou_page_video', group: 'Hero' },
                        { field_id: 'testimonials_headline_text', field_label: 'Testimonials Headline', field_type: 'text', maxLength: 100, ghl_key: '02_vsl_testimonials_headline_text', group: 'Testimonials' },
