...
export const VAULT_FIELD_STRUCTURES = {
    ...
    funnelCopy: {
        ...
        fields: [
            // FIELD 1: OPTIN PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'popup_form_headline', field_label: 'Popup Form Headline', field_type: 'textarea', rows: 2, maxLength: 100, placeholder: 'Enter your email to get instant access...', ghl_key: '03_opt_in_popup_form_headline', group: 'Popup' },
            ...
            // FIELD 3: CALENDAR PAGE (Booking Page)
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline', field_type: 'text', maxLength: 150, ghl_key: '03_calender_page_headline', group: 'Hero' },
                        { field_id: 'calendar_embedded_code', field_label: 'Calendar Embed Code', field_type: 'textarea', rows: 5, ghl_key: '03_calender_page_embedded_calender_code', group: 'Calendar', isHidden: true }
                    ],
            ...
            // FIELD 4: THANK YOU PAGE
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline', field_type: 'text', maxLength: 150, ghl_key: '03_thankyou_page_headline', group: 'Hero' },
                        { field_id: 'subheadline', field_label: 'Sub-Headline', field_type: 'textarea', rows: 3, maxLength: 200, ghl_key: '03_thankyou_page_sub__headline', group: 'Hero' },
                        { field_id: 'video_link', field_label: 'Video URL', field_type: 'text', placeholder: 'URL from media library (thank_you_video)', ghl_key: '03_thankyou_page_video_link', group: 'Hero', isHidden: true }
                    ],
...
funnelCopy: {
    ...
    media: {
        ...
        fields: [
            ...
            {
                field_id: 'testimonial_review_1_image',
                field_label: 'Testimonial 1 Photo',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Photo for testimonial review 1',
                    guidelines: [
            ...
            {
                field_id: 'testimonial_review_2_image',
                field_label: 'Testimonial 2 Photo',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Photo for testimonial review 2',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
            ...
            {
                field_id: 'testimonial_review_3_image',
                field_label: 'Testimonial 3 Photo',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Photo for testimonial review 3',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
            ...
            {
                field_id: 'testimonial_review_4_image',
                field_label: 'Testimonial 4 Photo',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Photo for testimonial review 4',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
