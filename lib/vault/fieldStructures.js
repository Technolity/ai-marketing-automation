...
export const VAULT_FIELD_STRUCTURES = {
        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    ...
                    placeholder: 'Coffee-talk phrase #{{index}}...',
                    hint: 'Mirror their language — use the exact words and phrases they use when describing their problem or desired outcome'
                },
                display_order: 4,
                group: 'Communication'
            }
    ...
    vslShort: {
        section_id: 'vslShort',
        section_title: 'Appointment Booking Video Script (Short Form)',
        fields: [
            // 1. Pattern Interrupt Hook
            {
                field_id: 'patternInterruptHook',
                field_label: 'Pattern Interrupt Hook',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: 'A bold statement that breaks a belief. Stop scrolling and reset thinking.',
                    hint: '🎬 0–15s — Open with something unexpected that makes them pause'
                },
                display_order: 1,
                group: 'Opening (0–75s)'
            },
            ...
            {
                field_id: 'identifyAudience',
                field_label: 'Identify the Audience',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: 'Clearly state who this video is for. Viewer thinks "this is for me."',
                    hint: '🎯 15–25s — Make them self-select in'
                },
                display_order: 2,
                group: 'Opening (0–75s)'
            },
            // 3. Amplify Core Pain
            {
                field_id: 'amplifyCorePain',
                field_label: 'Amplify the Core Pain',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: 'Describe the frustrations they are experiencing — inconsistent clients, ads not converting, funnels not working.',
                    hint: '😤 25–45s — Make them feel deeply understood'
                },
                display_order: 3,
                group: 'Opening (0–75s)'
            },
            ...
            {
                field_id: 'introduceEnemy',
                field_label: 'Introduce the Enemy / Broken System',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: '"The problem isn\'t you. The problem is the marketing system most gurus teach."',
                    hint: '👿 45–60s — Shift blame from viewer to the broken system'
                },
                display_order: 4,
                group: 'Opening (0–75s)'
            },
            // 5. Reveal Hidden Truth
            {
                field_id: 'revealHiddenTruth',
                field_label: 'Reveal the Hidden Truth (Epiphany)',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: '"The real reason most experts struggle is because they focus on tactics before authority."',
                    hint: '💡 60–75s — Trigger the paradigm shift'
                },
                display_order: 5,
                group: 'Opening (0–75s)'
            },
            ...
            {
                field_id: 'earlyCTA',
                field_label: 'Early Call-to-Action',
                field_type: 'textarea',
                field_metadata: {
                    rows: 3,
                    placeholder: '"If at any point during this video you feel like this could help you, click the button below and book a call."',
                    hint: '📲 ~75s — Capture fast decision-makers early'
                },
                display_order: 6,
                group: 'Authority & Framework (75–150s)'
            },
            // 7. Authority + Story
            {
                field_id: 'authorityStory',
                field_label: 'Authority + Credibility + Story',
                field_type: 'textarea',
                field_metadata: {
                    rows: 6,
                    placeholder: 'Years of experience, results generated, brands built, credentials. Why should they listen to you?',
                    hint: '🏆 75–120s — Build trust and authority'
                },
                display_order: 7,
                group: 'Authority & Framework (75–150s)'
            },
            // 8. Named Framework
            {
                field_id: 'namedFramework',
                field_label: 'Named Framework / Unique Mechanism',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: '"That\'s why I created the [Framework Name]." Explain why it works differently — 3 pillars.',
                    hint: '⚙️ 120–150s — People buy systems, not tactics'
                },
                display_order: 8,
                group: 'Authority & Framework (75–150s)'
            },
            ...
            {
                field_id: 'insightOne',
                field_label: 'Insight #1',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: 'First key insight. Concept → Quick success story / case study → Outcome.',
                    hint: '📚 Insight → Case Study → Outcome'
                },
                display_order: 9,
                group: 'Three Core Insights (150–300s)'
            },
            // 10. Insight #2
            {
                field_id: 'insightTwo',
                field_label: 'Insight #2',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: 'Second key insight. Different concept → Case study → Outcome.',
                    hint: '📚 Different angle → Social proof → Result'
                },
                display_order: 10,
                group: 'Three Core Insights (150–300s)'
            },
            // 11. Insight #3
            {
                field_id: 'insightThree',
                field_label: 'Insight #3',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: 'Third key insight. Different concept → Client transformation → Outcome.',
                    hint: '📚 Final insight → Transformation → Belief shift'
                },
                display_order: 11,
                group: 'Three Core Insights (150–300s)'
            },
            // 12. Micro-Commitment
            {
                field_id: 'microCommitment',
                field_label: 'Micro-Commitment Moment',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: '"So if what I\'ve shared so far makes sense… and you can see how this system could change how you attract clients…"',
                    hint: '🤝 Move viewer from passive → engaged'
                },
                display_order: 12,
                group: 'Closing Sequence (300–450s)'
            },
            // 13. Future Pace
            {
                field_id: 'futurePace',
                field_label: 'Future Pace the Outcome',
                field_type: 'textarea',
                field_metadata: {
                    rows: 5,
                    placeholder: '"Imagine waking up knowing your marketing is bringing qualified clients every day…"',
                    hint: '✨ 300–330s — Activate emotional desire'
                },
                display_order: 13,
                group: 'Closing Sequence (300–450s)'
            },
            // 14. Objection Handling
            {
                ...
                field_label: 'Objection Handling',
                field_type: 'textarea',
                field_metadata: {
                    rows: 6,
                    placeholder: 'Address 3-4 common doubts: "I don\'t have a big audience," "I\'ve tried funnels," "I\'m not good at marketing," "I don\'t have time."',
                    hint: '💭 330–390s — Remove friction and doubt'
                },
                display_order: 14,
                group: 'Closing Sequence (300–450s)'
            },
            // 15. Risk Reversal + Call Expectations
            {
                field_id: 'riskReversal',
                field_label: 'Risk Reversal + What Happens on the Call',
                field_type: 'textarea',
                field_metadata: {
                    rows: 6,
                    placeholder: '"This isn\'t a high-pressure sales call." Explain what happens: clarify message, identify offer, map out system.',
                    hint: '🛡️ 390–450s — Reduce fear, increase perceived call value'
                },
                display_order: 15,
                group: 'Closing Sequence (300–450s)'
            },
            ...
            {
                field_id: 'finalCTA',
                field_label: 'Final Call-to-Action (Closing)',
                field_type: 'textarea',
                field_metadata: {
                    rows: 4,
                    placeholder: '"Click the button below, choose a time, and let\'s see if we can help you scale your message and business."',
                    hint: '🔥 Clear, confident closing — drive the booking'
                },
                display_order: 16,
                group: 'Closing Sequence (300–450s)'
            }
    ...
    vsl: {
        section_id: 'vsl',
        section_title: 'Video Sales Letter (VSL)',
        fields: [
            // STEP 1: THE HOOK
            { field_id: 'step1_patternInterrupt', field_label: 'Step 1: Pattern Interrupt', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Attention-grabbing statement...', hint: 'Break their pattern immediately' }, display_order: 0, group: 'Step 1: The Hook' },
            { field_id: 'step1_characterIntro', field_label: 'Step 1: Character Intro', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Introduce yourself with personality...', hint: 'Humorous or dramatic angle' }, display_order: 1, group: 'Step 1: The Hook' },
            { field_id: 'step1_problemStatement', field_label: 'Step 1: Problem Statement', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'State the core problem...', hint: 'The big challenge they face' }, display_order: 2, group: 'Step 1: The Hook' },
            { field_id: 'step1_emotionalConnection', field_label: 'Step 1: Emotional Connection', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Personal story or relatable scenario...', hint: 'Create emotional resonance' }, display_order: 3, group: 'Step 1: The Hook' },

            // STEP 2: THE PROBLEM
            { field_id: 'step2_benefitLead', field_label: 'Step 2: Benefit Lead', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Highlight primary benefits...', hint: 'What they really want' }, display_order: 4, group: 'Step 2: The Problem' },
            { field_id: 'step2_uniqueSolution', field_label: 'Step 2: Unique Solution', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Introduce your solution...', hint: 'Why it works differently' }, display_order: 5, group: 'Step 2: The Problem' },
            { field_id: 'step2_benefitsHighlight', field_label: 'Step 2: Benefits Highlight', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Detail the impact...', hint: 'Life impact of benefits' }, display_order: 6, group: 'Step 2: The Problem' },
            { field_id: 'step2_problemAgitation', field_label: 'Step 2: Problem Agitation', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Cost of inaction...', hint: 'What happens if they don\'t solve it?' }, display_order: 7, group: 'Step 2: The Problem' },

            // STEP 3: THE EPIPHANY
            { field_id: 'step3_nightmareStory', field_label: 'Step 3: Nightmare Story', field_type: 'textarea', field_metadata: { rows: 5, placeholder: 'Story of major struggle...', hint: 'The low point before the breakthrough' }, display_order: 8, group: 'Step 3: The Epiphany' },
            { field_id: 'step3_clientTestimonials', field_label: 'Step 3: Client Testimonials', field_type: 'textarea', field_metadata: { rows: 5, placeholder: 'Success stories...', hint: 'Before and after scenarios' }, display_order: 9, group: 'Step 3: The Epiphany' },
            { field_id: 'step3_dataPoints', field_label: 'Step 3: Data Points', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Stats or achievements...', hint: 'Logical proof' }, display_order: 10, group: 'Step 3: The Epiphany' },
            { field_id: 'step3_expertEndorsements', field_label: 'Step 3: Expert Endorsements', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Credibility markers...', hint: 'Why trust you?' }, display_order: 11, group: 'Step 3: The Epiphany' },

            // STEP 4: THE SOLUTION
            { field_id: 'step4_detailedDescription', field_label: 'Step 4: Detailed Description', field_type: 'textarea', field_metadata: { rows: 5, placeholder: 'Features and process...', hint: 'How it works in detail' }, display_order: 12, group: 'Step 4: The Solution' },
            { field_id: 'step4_demonstration', field_label: 'Step 4: Demonstration', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Experience walkthrough...', hint: 'Show, don\'t just tell' }, display_order: 13, group: 'Step 4: The Solution' },
            { field_id: 'step4_psychologicalTriggers', field_label: 'Step 4: Psychological Triggers', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Scarcity, exclusivity...', hint: 'Why act now?' }, display_order: 14, group: 'Step 4: The Solution' },

            // STEP 5: THE VALUE
            { field_id: 'step5_intro', field_label: 'Step 5: Value Intro', field_type: 'textarea', field_metadata: { rows: 2, placeholder: 'Set up the value...', hint: 'Why you\'re sharing this' }, display_order: 15, group: 'Step 5: The Value' },
            { field_id: 'step5_tips', field_label: 'Step 5: 3 Core Tips', field_type: 'array', field_metadata: { minItems: 3, maxItems: 3, itemType: 'object', subfields: [{ field_id: 'title', field_label: 'Tip Title', field_type: 'text' }, { field_id: 'content', field_label: 'Tip Content', field_type: 'textarea', rows: 3 }, { field_id: 'actionStep', field_label: 'Action Step', field_type: 'textarea', rows: 2 }], placeholder: 'High-value tips...', hint: 'Give away the "what" and "why"' }, display_order: 16, group: 'Step 5: The Value' },
            { field_id: 'step5_transition', field_label: 'Step 5: Transition', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Pivot to the offer...', hint: 'From learning to doing' }, display_order: 17, group: 'Step 5: The Value' },

            // STEP 6: THE OFFER
            { field_id: 'step6_directEngagement', field_label: 'Step 6: Direct Engagement', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Interactive question...', hint: 'Get them nodding yes' }, display_order: 18, group: 'Step 6: The Offer' },
            { field_id: 'step6_urgencyCreation', field_label: 'Step 6: Urgency Creation', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Time-sensitive element...', hint: 'Why wait?' }, display_order: 19, group: 'Step 6: The Offer' },
            { field_id: 'step6_clearOffer', field_label: 'Step 6: Clear Offer', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'The irresistible offer...', hint: 'What they actually get' }, display_order: 20, group: 'Step 6: The Offer' },
            { field_id: 'step6_stepsToSuccess', field_label: 'Step 6: Steps to Success', field_type: 'array', field_metadata: { minItems: 4, maxItems: 4, itemType: 'text', placeholder: 'Step #{{index}}...', hint: 'Simple path to results' }, display_order: 21, group: 'Step 6: The Offer' },

            // STEP 7: THE STACK
            { field_id: 'step7_recap', field_label: 'Step 7: Recap', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Summarize key points...', hint: 'Remind them of the value' }, display_order: 22, group: 'Step 7: The Stack' },
            { field_id: 'step7_primaryCTA', field_label: 'Step 7: Primary CTA', field_type: 'textarea', field_metadata: { rows: 2, placeholder: 'Main call to action...', hint: 'Click the button below' }, display_order: 23, group: 'Step 7: The Stack' },
            { field_id: 'step7_offerFeaturesAndPrice', field_label: 'Step 7: Features & Price', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Features list and price...', hint: 'Value vs. Investment' }, display_order: 24, group: 'Step 7: The Stack' },
            { field_id: 'step7_bonuses', field_label: 'Step 7: Bonuses', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'List bonuses...', hint: 'Sweeten the deal' }, display_order: 25, group: 'Step 7: The Stack' },
            { field_id: 'step7_secondaryCTA', field_label: 'Step 7: Secondary CTA', field_type: 'textarea', field_metadata: { rows: 2, placeholder: 'Alternative action...', hint: 'If not ready to buy yet' }, display_order: 26, group: 'Step 7: The Stack' },
            { field_id: 'step7_guarantee', field_label: 'Step 7: Guarantee', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Strong guarantee...', hint: 'Reverse the risk' }, display_order: 27, group: 'Step 7: The Stack' },

            // STEP 8: THE CLOSE
            { field_id: 'step8_theClose', field_label: 'Step 8: The Close', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Conclude with urgency...', hint: 'Final push' }, display_order: 28, group: 'Step 8: The Close' },
            { field_id: 'step8_addressObjections', field_label: 'Step 8: Address Objections', field_type: 'textarea', field_metadata: { rows: 5, placeholder: 'Handle 2-3 objections...', hint: 'Why they might say no' }, display_order: 29, group: 'Step 8: The Close' },
            { field_id: 'step8_reiterateValue', field_label: 'Step 8: Reiterate Value', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Future benefits...', hint: 'Ongoing support' }, display_order: 30, group: 'Step 8: The Close' },

            // STEP 9: THE FUTURE
            { field_id: 'step9_followUpStrategy', field_label: 'Step 9: Follow-Up', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'What happens next...', hint: 'Set expectations' }, display_order: 31, group: 'Step 9: The Future' },
            { field_id: 'step9_finalPersuasion', field_label: 'Step 9: Final Persuasion', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Final value prop...', hint: 'Leave them with a strong thought' }, display_order: 32, group: 'Step 9: The Future' },

            // STEP 10: FINAL PUSH
            { field_id: 'step10_hardClose', field_label: 'Step 10: Hard Close', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Close hard on the goal...', hint: 'Ask for the sale' }, display_order: 33, group: 'Step 10: Final Push' },
            { field_id: 'step10_handleObjectionsAgain', field_label: 'Step 10: Objection Handler', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Handle biggest objection...', hint: 'Last barrier removal' }, display_order: 34, group: 'Step 10: Final Push' },
            { field_id: 'step10_scarcityClose', field_label: 'Step 10: Scarcity Close', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Scarcity element...', hint: 'Limited time/spots' }, display_order: 35, group: 'Step 10: Final Push' },
            { field_id: 'step10_inspirationClose', field_label: 'Step 10: Inspiration Close', field_type: 'textarea', field_metadata: { rows: 4, placeholder: 'Inspirational ending...', hint: 'Connect to their dream' }, display_order: 36, group: 'Step 10: Final Push' },
            { field_id: 'step10_speedUpAction', field_label: 'Step 10: Speed Up Action', field_type: 'textarea', field_metadata: { rows: 3, placeholder: 'Final urgency...', hint: 'Do it NOW' }, display_order: 37, group: 'Step 10: Final Push' }
        ]
    },
        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    ...
                    itemType: 'object',
                    subfields: [
                        { field_id: 'title', field_label: 'Title', field_type: 'text', placeholder: 'Deliverable title...' },
                        { field_id: 'description', field_label: 'Description', field_type: 'textarea', rows: 2, placeholder: 'What this deliverable provides...' }
                    ],
                    placeholder: 'Deliverable #{{index}}',
    ...
    emails: {
        ...
        fields: [
            ...
            // DAY 8 CLOSING
            { field_id: 'email8a', field_label: 'Day 8 Morning - Why a Call Helps', field_type: 'object', field_metadata: { subfields: [{ field_id: 'subject', field_label: 'Subject', field_type: 'text', maxLength: 150 }, { field_id: 'preview', field_label: 'Preview', field_type: 'text', maxLength: 200 }, { field_id: 'body', field_label: 'Body (250-400 words)', field_type: 'html', rows: 10, maxLength: 3000 }], hint: '📍 CLOSE 1 Morning: Remove friction' }, display_order: 7 },
            { field_id: 'email8b', field_label: 'Day 8 Afternoon - Success Story', field_type: 'object', field_metadata: { subfields: [{ field_id: 'subject', field_label: 'Subject', field_type: 'text', maxLength: 150 }, { field_id: 'preview', field_label: 'Preview', field_type: 'text', maxLength: 200 }, { field_id: 'body', field_label: 'Body (300-500 words)', field_type: 'html', rows: 10, maxLength: 3000 }], hint: '📍 CLOSE 1 Afternoon: Social proof' }, display_order: 8 },
            { field_id: 'email8c', field_label: 'Day 8 Evening - Last Chance This Week', field_type: 'object', field_metadata: { subfields: [{ field_id: 'subject', field_label: 'Subject', field_type: 'text', maxLength: 150 }, { field_id: 'preview', field_label: 'Preview', field_type: 'text', maxLength: 200 }, { field_id: 'body', field_label: 'Body (200-350 words)', field_type: 'html', rows: 8, maxLength: 3000 }], hint: '📍 CLOSE 1 Evening: Mild urgency' }, display_order: 9 },

            // DAYS 9-14
            { field_id: 'email9', field_label: 'Day 9 - Advanced: Mindset/Strategy', field_type: 'object', field_metadata: { subfields: [{ field_id: 'subject', field_label: 'Subject', field_type: 'text', maxLength: 150 }, { field_id: 'preview', field_label: 'Preview', field_type: 'text', maxLength: 200 }, { field_id: 'body', field_label: 'Body (350-550 words)', field_type: 'html', rows: 12, maxLength: 3000 }], hint: '📍 Advanced: Mindset shifts' }, display_order: 10 },
    ...
    bio: {
        ...
        fields: [
            ...
            },
            {
                ...
                field_label: 'Key Achievements (3-5 bullet points)',
                field_type: 'array',
                field_metadata: {
                    minItems: 3,
                    maxItems: 5,
    ...
    appointmentReminders: {
        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 8, placeholder: 'Confirmation email with what to expect, how to prepare, and encouragement...' }
                    ],
            ...
            {
                field_id: 'reminder48Hours',
                field_label: '48-Hour Reminder',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'subject', field_label: 'Subject Line', field_type: 'text', placeholder: '📅 Your call is in 2 days!' },
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 8, placeholder: '48hr reminder with value preview and preparation tips...' }
                    ],
                    hint: 'Sent 48 hours before appointment'
                },
                display_order: 2
            },
            {
                field_id: 'reminder24Hours',
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 8, placeholder: 'Reminder with preparation checklist and value preview...' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 6, placeholder: 'Final reminder with quick prep checklist and session link...' }
                    ],
            ...
            {
                field_id: 'reminder10Minutes',
                field_label: '10-Minute Reminder',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'subject', field_label: 'Subject Line', field_type: 'text', placeholder: '🔔 Starting in 10 minutes!' },
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 4, placeholder: 'Quick reminder with join link...' }
                    ],
                    hint: 'Sent 10 minutes before appointment'
                },
                display_order: 5
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 4, placeholder: 'Urgent join reminder with session link...' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        ...
                        { field_id: 'previewText', field_label: 'Preview Text', field_type: 'text', placeholder: 'Plain text preview...' },
                        { field_id: 'body', field_label: 'Email Body', field_type: 'html', rows: 8, placeholder: 'Caring follow-up with reschedule link...' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'confirmationSms', field_label: 'Booking Confirmation SMS', field_type: 'object', placeholder: 'SMS sent when call is booked...' },
                        { field_id: 'reminder48HoursSms', field_label: '48-Hour SMS', field_type: 'object', placeholder: 'SMS for 48hr reminder...' },
                        { field_id: 'reminder24HoursSms', field_label: '24-Hour SMS', field_type: 'object', placeholder: 'SMS for 24hr reminder...' },
                        { field_id: 'reminder1HourSms', field_label: '1-Hour SMS', field_type: 'object', placeholder: 'SMS for 1hr reminder...' },
                        { field_id: 'reminder10MinSms', field_label: '10-Minute SMS', field_type: 'object', placeholder: 'SMS for 10min reminder...' },
                        { field_id: 'startingNowSms', field_label: 'Starting Now SMS', field_type: 'object', placeholder: 'SMS sent at appointment time...' }
                    ],
                    hint: 'Text message reminders (each with timing + message)'
                },
                display_order: 8
            }
        ]
        ...
        fields: [
            {
                ...
                field_metadata: {
                    ...
                    guidelines: [
                        ...
                        '📋 Recommended size: Max 200px wide × 60px tall',
                        '📋 SVG format provides best quality at any size',
                        '📋 For best results, remove background before uploading'
                    ],
                    accept: 'image/*',
            ...
            },
            {
                ...
                field_metadata: {
                    placeholder: 'Paste video embed URL (e.g. https://www.youtube.com/embed/...)',
    ...
    sms: {
        ...
        fields: [
            ...
            {
                field_id: 'sms8a',
                field_label: 'SMS 8a: Closing Morning',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 8 - Morning' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Why a call helps (remove friction)'
                },
                display_order: 8
            },
            {
                field_id: 'sms8b',
                field_label: 'SMS 8b: Closing Afternoon',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 8 - Afternoon' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Success story (social proof)'
                },
                display_order: 9
            },
            {
                field_id: 'sms8c',
                field_label: 'SMS 8c: Closing Evening',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 8 - Evening' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Last chance this week (urgency)'
                },
                display_order: 10
            },
            {
                field_id: 'sms9',
                field_label: 'SMS 9: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 9' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Mindset/Strategy tip'
                },
                display_order: 11
            },
            {
                field_id: 'sms10',
                field_label: 'SMS 10: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 10' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Common mistakes tip'
                },
                display_order: 12
            },
            {
                field_id: 'sms11',
                field_label: 'SMS 11: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 11' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'What is really holding them back'
                },
                display_order: 13
            },
            {
                field_id: 'sms12',
                field_label: 'SMS 12: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 12' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Behind-the-scenes teaching'
                },
                display_order: 14
            },
            {
                field_id: 'sms13',
                field_label: 'SMS 13: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 13' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Results Timeline tip'
                },
                display_order: 15
            },
            {
                field_id: 'sms14',
                field_label: 'SMS 14: Advanced Tip',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 14' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Simplify execution tip'
                },
                display_order: 16
            },
            {
                field_id: 'sms15a',
                field_label: 'SMS 15a: Final Closing Morning',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 15 - Morning' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Final day to book consultation'
                },
                display_order: 17
            },
            {
                field_id: 'sms15b',
                field_label: 'SMS 15b: Final Closing Afternoon',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 15 - Afternoon' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'FAQ/Objection handling'
                },
                display_order: 18
            },
            {
                field_id: 'sms15c',
                field_label: 'SMS 15c: Final Closing Evening',
                field_type: 'object',
                field_metadata: {
                    subfields: [
                        { field_id: 'timing', field_label: 'Timing', field_type: 'text', placeholder: 'e.g., Day 15 - Evening' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 2, placeholder: 'SMS message (under 160 chars)...' }
                    ],
                    hint: 'Final emotional push + strongest CTA'
                },
                display_order: 19
            },
            {
    ...
    */
    ...
    // ============================================================
    // FUNNEL COPY SECTION - NEW 03_* STRUCTURE (TEXT ONLY)
    // optinPage (5 fields) + salesPage (69 fields) + calendarPage (3 fields) + thankYouPage (3 fields) = 80 total fields
    ...
    funnelCopy: {
        ...
        fields: [
            // ============ OPTIN PAGE (5 fields) ============
            {
                ...
                field_metadata: {
                    ...
                    subfields: [
                        ...
                        {
                            field_id: 'popup_form_headline',
                            field_label: 'Popup Form Headline',
                            field_type: 'textarea',
                            field_metadata: { maxLength: 100, placeholder: 'Enter your email to get instant access...' },
                            group: 'Popup'
                        },
                        {
                            field_id: 'footer_text',
                            field_label: 'Footer Copyright',
                            field_type: 'text',
                            field_metadata: { maxLength: 200, placeholder: 'Copyrighted By "Business Name" 2026 |Terms & Conditions' },
                            group: 'Footer'
                        },
                    ]
                },
            ...
            // ============ SALES PAGE / VSL (69 fields) ============
            {
                field_id: 'salesPage',
                field_label: 'Appointment Booking Page',
                field_type: 'nested_object',
                field_metadata: {
                    hint: 'Video Sales Letter landing page copy (69 fields)',
                    subfields: [
                        ...
                        },
                        {
                            ...
                            field_type: 'textarea',
                            field_metadata: { maxLength: 8000, placeholder: 'Bio paragraph (use story context)...' },
                            group: 'Bio Section'
                        },
                    ...
                    subfields: [
                        {
                            ...
                            field_label: 'Headline',
                            field_type: 'text',
                            field_metadata: { maxLength: 150, placeholder: 'Book your call now' },
                            group: 'Calendar Page'
                        },
                        {
                            field_id: 'calendar_embedded_code',
                            field_label: 'Calendar Embed Code',
                            field_type: 'textarea',
                            field_metadata: { maxLength: 1000, placeholder: 'Embed code (optional)' },
                            group: 'Calendar Page'
                        },
                        {
                            field_id: 'footer_text',
                ...
                field_metadata: {
                    ...
                    subfields: [
                        ...
                        },
                        {
                            ...
                            field_label: 'Subheadline',
                            field_type: 'textarea',
                            field_metadata: { maxLength: 300, placeholder: 'Next steps and what to expect' },
                            group: 'Thank You Page'
                        },
                        {
                            field_id: 'footer_text',
        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'This is the image of your Free Gift',
            ...
            {
                field_id: 'vsl_video',
                field_label: 'Appointment Booking Video URL',
                field_type: 'video_url',
                field_metadata: {
                    hint: 'Paste the embed URL of your video (e.g. YouTube: Share → Embed → copy src URL)',
            ...
            },
            {
                ...
                field_type: 'video_url',
                field_metadata: {
                    hint: 'Paste the embed URL of your Thank You page video (not the watch URL)',
                    customValueKey: '03_thankyou_page_video_link'
                },
                display_order: 4
            },
            // Testimonial Images (4 fields)
            {
                ...
                field_label: 'Testimonial 1 Photo (Optional)',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Optional: Photo for testimonial review 1',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
                    ],
                    customValueKey: '03_vsl_testimonial_review_1_image'
                },
                display_order: 5
            },
            {
                field_id: 'testimonial_review_2_image',
                field_label: 'Testimonial 2 Photo (Optional)',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Optional: Photo for testimonial review 2',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
                    ],
                    customValueKey: '03_vsl_testimonial_review_2_image'
                },
                display_order: 6
            },
            {
                field_id: 'testimonial_review_3_image',
                field_label: 'Testimonial 3 Photo (Optional)',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Optional: Photo for testimonial review 3',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
                    ],
                    customValueKey: '03_vsl_testimonial_review_3_image'
                },
                display_order: 7
            },
            {
                field_id: 'testimonial_review_4_image',
                field_label: 'Testimonial 4 Photo (Optional)',
                field_type: 'cloudinary_image',
                field_metadata: {
                    accept: 'image/*',
                    maxSize: 10485760, // 10MB
                    hint: 'Optional: Photo for testimonial review 4',
                    guidelines: [
                        '📋 Recommended: Square image (1:1 ratio)',
                        '📋 Minimum size: 200x200 pixels',
                        '📋 Professional headshot works best'
                    ],
                    customValueKey: '03_vsl_testimonial_review_4_image'
                },
                display_order: 8
            }
        ]
