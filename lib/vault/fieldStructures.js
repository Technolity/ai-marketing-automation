        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    ...
                    itemType: 'object',
                    subfields: [
                        { field_id: 'stepName', field_label: 'Step Name', field_type: 'text', placeholder: 'Step {{index}} Name...' },
                        { field_id: 'whatItIs', field_label: 'What It Is', field_type: 'textarea', rows: 2, placeholder: 'Brief description of this step...' },
                        { field_id: 'problemSolved', field_label: 'Problem It Solves', field_type: 'textarea', rows: 2, placeholder: 'What problem does this step address?' },
                        { field_id: 'outcomeCreated', field_label: 'Outcome Created', field_type: 'textarea', rows: 2, placeholder: 'What outcome does the client achieve?' }
                    ],
        ...
        fields: [
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline (matches opt-in hook)', field_type: 'text', placeholder: 'Short, punchy headline...' },
                        { field_id: 'primaryText', field_label: 'Ad Copy', field_type: 'textarea', rows: 6, placeholder: 'Quick hook → pain point → CTA. ~100 words.' },
                        { field_id: 'cta', field_label: 'Call to Action', field_type: 'text', placeholder: 'Learn More, Download, etc.' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline (different angle)', field_type: 'text', placeholder: 'Alternative headline angle...' },
                        { field_id: 'primaryText', field_label: 'Ad Copy', field_type: 'textarea', rows: 6, placeholder: 'Different hook → outcome focus → CTA. ~100 words.' },
                        { field_id: 'cta', field_label: 'Call to Action', field_type: 'text', placeholder: 'Get Access, Sign Up, etc.' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline (story-driven)', field_type: 'text', placeholder: 'Compelling story headline...' },
                        { field_id: 'primaryText', field_label: 'Ad Copy', field_type: 'textarea', rows: 12, placeholder: 'Story hook → problem → solution → proof → benefits → CTA. ~250 words.' },
                        { field_id: 'cta', field_label: 'Call to Action', field_type: 'text', placeholder: 'Book Now, Get Started, etc.' }
                    ],
