    ...
    funnelCopy: {
        ...
        fields: [
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline', field_type: 'text', placeholder: 'Main attention-grabbing headline' },
                        { field_id: 'subheadline', field_label: 'Subheadline', field_type: 'textarea', rows: 2, placeholder: 'Supporting text that adds context' },
                        { field_id: 'heroText', field_label: 'Hero Section', field_type: 'textarea', rows: 3, placeholder: '2-3 sentences hook about the pain/desire' },
                        { field_id: 'bulletPoints', field_label: 'Benefit Bullets (4)', field_type: 'array', minItems: 4, maxItems: 4, itemType: 'text', placeholder: 'Bullet #{{index}}...' },
                        { field_id: 'ctaButton', field_label: 'CTA Button Text', field_type: 'text', placeholder: 'Get Instant Access' },
                        { field_id: 'socialProof', field_label: 'Social Proof', field_type: 'text', placeholder: 'Joined by 5,000+ professionals...' },
                        { field_id: 'privacyNote', field_label: 'Privacy Note', field_type: 'text', placeholder: 'We respect your privacy. Unsubscribe anytime.' }
                    ],
            ...
            },
            {
                ...
                field_metadata: {
                    subfields: [
                        { field_id: 'headline', field_label: 'Headline', field_type: 'text', placeholder: 'You\'re In! Here\'s What Happens Next...' },
                        { field_id: 'subheadline', field_label: 'Subheadline', field_type: 'textarea', rows: 2, placeholder: 'Check your inbox for your free guide + a special surprise...' },
                        { field_id: 'message', field_label: 'Message', field_type: 'textarea', rows: 3, placeholder: 'What they should do while waiting, what to expect...' },
                        { field_id: 'nextSteps', field_label: 'Next Steps (3)', field_type: 'array', minItems: 3, maxItems: 3, itemType: 'text', placeholder: 'Step #{{index}}...' },
                        { field_id: 'bridgeToCall', field_label: 'Bridge to Consultation', field_type: 'textarea', rows: 3, placeholder: 'Want faster results? Book a free strategy call...' },
                        { field_id: 'ctaButton', field_label: 'CTA Button Text', field_type: 'text', placeholder: 'Book Your Free Strategy Call' }
                    ],
