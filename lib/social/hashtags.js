...
const PLATFORM_RULES = {
  x:         { count: '1–2',   reason: 'X users dislike hashtag spam' },
 ...
 * @param {'x'|'instagram'|'facebook'} platform
 ...
 *
 * X         → hashtags on same line, truncated to 280 chars total
