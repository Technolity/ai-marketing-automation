...
export async function importSnapshotToSubAccount(userId, snapshotId) {
    try {
        ...
        const requestBody = {
            ...
            shareType: 'agency_link',
            locationId: subaccount.location_id,
        };

        console.log('[GHL Snapshot] Request body:', JSON.stringify(requestBody, null, 2));
        ...
        if (!importResponse.ok) {
            ...
            console.error('[GHL Snapshot] Request sent was:', JSON.stringify(requestBody, null, 2));
