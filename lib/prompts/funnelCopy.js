/**
 * Funnel Copy Generator - 80-Field Text-Only Structure
 * Generates Optin, Sales, Calendar, and Thank You pages
...
2. **Appointment Booking Page** (69 fields) - Complete video sales letter page
3. **Calendar Page** (3 fields) - Booking page copy
4. **Thank You Page** (3 fields) - Post-booking confirmation copy
...

{
  ...
  "salesPage": {
    ...
    "bio_paragraph_text": "Brief bio paragraph (Max 300 words, NO paragraph breaks — write as a single continuous block of text with no line breaks or paragraph separations, avoid dashes) - Focus entirely on who the founder is, their story, and what they offer.",
    ...
    "testimonial_review_1_subheadline_with_name": "Short testimonial with name (15-20 words ONLY) ending with '— [Name], [Title/Role]'.",

    "testimonial_review_2_headline": "Result-focused headline for testimonial 2",
    "testimonial_review_2_subheadline_with_name": "Short testimonial with name (15-20 words ONLY) ending with '— [Name], [Title/Role]'",

    "testimonial_review_3_headline": "Result-focused headline for testimonial 3",
    "testimonial_review_3_subheadline_with_name": "Short testimonial with name (15-20 words ONLY) ending with '— [Name], [Title/Role]'",

    "testimonial_review_4_headline": "Result-focused headline for testimonial 4",
    "testimonial_review_4_subheadline_with_name": "Short testimonial with name (15-20 words ONLY) ending with '— [Name], [Title/Role]'",
  ...
  "calendarPage": {
    "headline": "Calendar booking headline (under 150 chars)",
    "calendar_embedded_code": "",
    "footer_text": "Copyrighted By \"${businessName}\" 2026 |Terms & Conditions"
  },
  "thankYouPage": {
    "headline": "Confirmation headline (under 150 chars)",
    "subheadline": "Next steps and what to expect (under 300 chars)",
    "footer_text": "Copyrighted By \"${businessName}\" 2026 |Terms & Conditions"
  }
}
...
4. Add markdown formatting or code blocks
5. Generate fields outside the schema shown above
