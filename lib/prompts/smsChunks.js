...
• Always include {{custom_values.schedule_link}} for booking links
• No emojis overload - max 1-2 per message
• Be direct and action-oriented
• Use {{custom_values.schedule_link}} NOT [Schedule Link] - this is the GHL custom value for booking
`;
