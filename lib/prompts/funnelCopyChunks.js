...
OUTPUT FORMAT (valid JSON only):
{
  "salesPage_part2": {
    ...
    "bio_paragraph_text": "Bio story paragraph — STRICT MAX 120 WORDS, exactly 2 short paragraphs. First-person voice. Structure: Para 1 = Who they are + their struggle/low moment → breakthrough. Para 2 = What they now do for clients + key result/credential. No dashes, no bullet points, no excessive spacing. Conversational and warm. Example length/style: 'I'm the founder of [Business]. I was [struggle] while [context]—[low moment]. After [turning point] I discovered [method]. Within [timeframe], [personal result]. Now I help [audience] use [method] to [outcome].'"
  }
}
...
- bio_paragraph_text: Tell the origin story in FIRST PERSON. STRICT MAX 120 WORDS — exactly 2 short paragraphs:
  Para 1: Who they are + their struggle/low moment (${ctx.storyLowMoment}) → the turning point / breakthrough (${ctx.storyBreakthrough}).
  Para 2: What they now do for clients + key credential/proof (${ctx.credentials}).
  Rules: First-person voice ("I"), conversational and warm, no dashes, no bullets, no excessive spacing.
  Example length/style: "I'm the founder of Love Reset Coaching. I was a therapist helping clients with their relationships while my own love life was a disaster... Within 8 months, I met my husband. Now I help others use the Secure Attraction Method to stop chasing inconsistency and start building secure, steady relationships."
