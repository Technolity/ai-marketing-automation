...
OUTPUT FORMAT (valid JSON only):
{
  "salesPage_part2": {
    ...
    "bio_paragraph_text": "Bio story paragraph (Max 300 words, strictly ~2 paragraphs, avoid excessive spacing and dashes) - Focus entirely on who the founder is, their story, and what they offer."
  }
}
...
- bio_paragraph_text: Tell origin story. Use this structure:
  ...
  Keep it conversational, not salesy. VERY BRIEF: Max 300 words. Strictly ~2 paragraphs total. Avoid excessive spacing and do not use a lot of dashes. Focus entirely on who the founder is, their story, and the core offer.
