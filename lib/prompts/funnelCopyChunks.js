...
OUTPUT FORMAT (valid JSON only):
{
  "salesPage_part2": {
    ...
    "bio_paragraph_text": "Bio story paragraph (Max 300 words, NO paragraph breaks — write as a single continuous block of text with no line breaks or paragraph separations, avoid dashes) - Focus entirely on who the founder is, their story, and what they offer."
  }
}
...
- bio_paragraph_text: Tell origin story. Use this structure:
  ...
  Keep it conversational, not salesy. VERY BRIEF: Max 300 words. NO paragraph breaks — write as a single continuous block of text with no line breaks or paragraph separations. Do not use dashes. Focus entirely on who the founder is, their story, and the core offer.
