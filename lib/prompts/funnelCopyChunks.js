...
OUTPUT FORMAT (valid JSON only):
{
  "salesPage_part2": {
    ...
    "bio_paragraph_text": "Bio story paragraph (up to 700 words. Use few paragraphs, avoid excessive spacing)"
  }
}
...
- bio_paragraph_text: Tell origin story. Use this structure:
  ...
  Keep it conversational, not salesy. Up to 700 words max. Use only a few paragraphs and avoid excessive spacing or line breaks.
