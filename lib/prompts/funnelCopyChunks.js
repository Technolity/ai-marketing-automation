...
{
  "optinPage": {
    "headline_text": "Main headline that hooks attention and promises transformation (6-10 words STRICTLY)",
    "subheadline_text": "Supporting text that expands on the promise and creates urgency (12-16 words STRICTLY)",
    "cta_button_text": "Action-oriented button text (2-3 words MAX, e.g., 'Get Access', 'Download Now')",
...
1. headline_text (6-10 words STRICTLY):
   - Hook attention immediately with a power statement
   ...
   - Example: "Stop Losing Leads to Your Competitors" (7 words)
   - Example: "The Hidden Secret to 3X More Conversions" (8 words)

2. subheadline_text (12-16 words STRICTLY):
   ...
   - Example: "Get the exact 5-step framework used by top performers to double revenue in 90 days" (15 words)

3. cta_button_text (2-3 words MAX):
   - Short, punchy, action-oriented
   - Use "Get", "Download", "Access", "Grab", "Claim"
   - Specify what they're getting concisely
   - Examples: "Get Access", "Download Now", "Grab Free", "Start Now"
...
- audience_callout_for_1-3: Specific avatar descriptions (10-15 words each, CONSISTENT LENGTH).
  CRITICAL: All 3 "For" bullets must be SIMILAR in length and structure.
  Format: "You're a [type] who [specific situation/goal/struggle]"
  Make them nod their head in recognition.
  Example patterns:
  - "You're a coach who's tired of trading time for money and wants predictable income"
  - "You're a service provider struggling to attract high-paying clients consistently"
  - "You're an entrepreneur ready to scale beyond $10K months but unsure how"

- audience_callout_not_headline: "This Is NOT For You If..."
- audience_callout_not_1-3: Disqualify bad fits (10-15 words each, CONSISTENT LENGTH).
  CRITICAL: All 3 "Not For" bullets must be SIMILAR in length and structure.
  Be direct and filter out wrong-fit prospects.
  Example patterns:
  - "You're looking for a quick fix or overnight success without putting in work"
  - "You're not willing to invest in yourself or your business growth"
  - "You're hoping someone else will do all the work while you sit back"
...
- call_expectations_is_for_bullet_1-3: Who should book (10-15 words each, CONSISTENT LENGTH).
  CRITICAL: All 3 bullets must be SIMILAR in length and structure.
  Format: "You're ready to [specific action/commitment]"
  Examples:
  - "You're ready to invest in a proven system that will accelerate your results"
  - "You want clarity on exactly what's holding you back from hitting goals"
  - "You're committed to taking action and implementing what you learn on this call"

- call_expectations_not_for_headline: "This Call Is NOT For..."
- call_expectations_not_for_bullet_1-3: Who shouldn't book (10-15 words each, CONSISTENT LENGTH).
  CRITICAL: All 3 bullets must be SIMILAR in length and structure.
  Format: "You're [negative behavior/situation that disqualifies]"
  Examples:
  - "You're just browsing and not serious about making a change in your business"
  - "You're not in a position to invest in coaching or high-ticket services"
  - "You expect us to do everything for you without any effort on your part"
