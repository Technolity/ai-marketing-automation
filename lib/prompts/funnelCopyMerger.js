 ...
 * Total salesPage: 23+22+23 = 68 fields
...
export function mergeFunnelCopyChunks(chunk1, chunk2, chunk3, chunk4) {
    ...
    console.log('[FunnelCopyMerger] salesPage fields:', salesCount, '(expected: 68)');
    ...
    if (salesCount !== 68) {
        console.warn('[FunnelCopyMerger] ⚠️ WARNING: salesPage has', salesCount, 'fields (expected: 68)');
    }
    if (calendarCount !== 3) {
...
/**
 * Validate merged funnel copy structure (79-field structure)
...
export function validateMergedFunnelCopy(merged) {
    ...
    const expectedFieldCounts = {
        ...
        salesPage: 68,         // All Appointment Booking page text fields (23+22+23)
 ...
 * 79-field structure: optinPage + salesPage + calendarPage + thankYouPage
 */
...
const funnelCopyMerger = {
    mergeFunnelCopyChunks,
    validateMergedFunnelCopy,
    getFieldCounts
};

export default funnelCopyMerger;
