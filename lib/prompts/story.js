...
JSON OUTPUT (NO markdown formatting — no **bold**, no _italic_, no # headers, no asterisks anywhere):
{
  "bigIdea": "The key insight/breakthrough concept (1-2 sentences)",
  "networkingStory": "📍 Use for: Networking events, podcasts, casual conversations. 60-90s fast conversational story. Write each phase as flowing text (Pit, Search, Breakthrough, Outcome). NO markdown formatting, NO bold headers, NO asterisks. 1-2 sentences per phase. Ends: 'Now I help [Client] [Outcome] using [Method]'",
