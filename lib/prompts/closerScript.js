...
JSON OUTPUT (no markdown, no placeholders):
{
  ...
  "discoveryQuestions": [
    {
      ...
      "question": "Exact phrasing of the question (MANDATORY must match key 'question')",
      "lookingFor": "What to listen for (must match key 'lookingFor')",
      "ifVague": "Follow-up probe (must match key 'ifVague')"
    },
    ... (7 questions total)
  ],
  ...
  "proofLine": "Social proof or success story. CRITICAL: If no specific proof is provided in inputs, GENERATE A HYPOTHETICAL STORY based on the industry and ideal client. MUST NOT BE EMPTY.",
...
1. Ensure 'discoveryQuestions' array has exactly 7 items.
2. Ensure each discovery question object has exactly these keys: "label", "question", "lookingFor", "ifVague".
3. Ensure 'proofLine' is NOT empty. If no proof is found, invent a plausible success story.
