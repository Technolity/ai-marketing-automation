  ...
  "discoveryQuestions": [
    {
      ...
      "question": "Exact phrasing of the question (MANDATORY - do not omit)",
      "lookingFor": "What to listen for",
      "ifVague": "Follow-up probe"
    },
    ... (7 total)
  ],
...
Fully generate all content - personalized, realistic, conversational. No "..." placeholders. Ensure 'discoveryQuestions' has all 7 questions with 'question' field populated. Ensure 'proofLine' is NOT empty.
`;
