...
OUTPUT EXACT JSON (no markdown):
{
  ...
  "commitmentQuestions": {
    "commitmentScale": "Full script for asking 'On a scale of 1-10, how committed are you?' — include how to ask, what each answer range means (1-3, 4-6, 7-10), and follow-up responses for each.",
    "costOfInaction": "Full script for asking 'What's it costing you NOT to solve this?' — include how to ask, how to dig deeper into emotional cost, financial cost, and future impact."
  },
  "financialQuestions": {
    "currentIncome": "Tactful script for asking about their current income/revenue — include the exact question, why you're asking, and how to frame it.",
    "willingnessToInvest": "Script for asking about their investment capacity — include the exact question and how to handle different responses.",
    "budgetRange": "Response scripts for different budget ranges — include what to say for low budget, mid budget, and ideal budget scenarios."
  },
  "fullGuidedScript": {
