...
export { brandColorsPrompt } from './brandColors'; // Brand Colors AI Generation
export { shortVslPrompt } from './shortVsl'; // Short Form VSL Script
...
export const PROMPTS = {
    ...
    20: 'brandColors',        // Brand Colors
    21: 'vslShort'            // Short Form VSL Script
};
...
export const getPromptByKey = (key) => {
    const promptMap = {
        ...
        20: require('./brandColors').default,
        21: require('./shortVsl').default
    };
