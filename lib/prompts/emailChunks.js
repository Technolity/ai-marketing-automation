...
- Body: 250-400 words - deliver gift, set expectations, soft CTA
  **MUST USE HTML FORMATTING** - wrap paragraphs in <p></p>, use <strong> for emphasis, end with booking link using [BOOKING_LINK]
...
Return ONLY valid JSON (no markdown code blocks):
{
  ...
  "email2": {
    ...
    "body": "HTML-formatted body with <p> tags, <strong> emphasis, and [BOOKING_LINK]"
  },
  "email3": {
    "subject": "Complete subject line",
    "preview": "Preview text",
...
- Body: 300-500 words - **MUST USE HTML FORMATTING** (<p>, <strong>, lists if needed, [BOOKING_LINK])
...
{
  "email5": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"},
  "email6": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"},
  "email7": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"},
  "email8a": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and <strong><a href=\\"[BOOKING_LINK]\\">Book your call</a></strong>"},
  "email8b": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"},
  "email8c": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"}
}
...
- **MUST USE HTML FORMATTING** (<p>, <strong>, <ul><li> for lists, [BOOKING_LINK])
...
Return ONLY valid JSON (no markdown):
{
  "email9": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <strong>, lists, and [BOOKING_LINK]"},
  "email10": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <ul><li> for mistakes list, and [BOOKING_LINK]"},
  "email11": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"},
  "email12": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and [BOOKING_LINK]"}
}
...
- **MUST USE HTML FORMATTING** (<p>, <ol><li> for timeline steps, [BOOKING_LINK])

**Email 14 (Day 14)** - Simplify
- Body: 350-550 words
- ADVANCED: How to simplify + make it actionable
- **MUST USE HTML FORMATTING** (<p>, <ul><li> for action steps, [BOOKING_LINK])

**Email 15a (Day 15 Morning)** - CLOSE 2: Final Day
- Body: 300-500 words
- Final day to book, clear value
- **MUST USE HTML FORMATTING** - emphasize booking link with <strong><a href="[BOOKING_LINK]">
...
Return ONLY valid JSON (no markdown):
{
  "email13": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <ol><li> for timeline, and [BOOKING_LINK]"},
  "email14": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <ul><li> for steps, and [BOOKING_LINK]"},
  "email15a": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags and <strong><a href=\\"[BOOKING_LINK]\\">Book now</a></strong>"},
  "email15b": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <ul><li> for FAQ, and strong [BOOKING_LINK] CTA"},
  "email15c": {"subject": "...", "preview": "...", "body": "HTML-formatted body with <p> tags, <strong> emphasis, and STRONGEST [BOOKING_LINK] CTA"}
}
