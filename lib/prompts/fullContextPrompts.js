...
OUTPUT MUST MATCH THIS EXACT SCHEMA:
{
  ...
  "top3Challenges": ["Specific Pain 1 (Urgent)", "Specific Pain 2 (Annoying)", "Specific Pain 3 (Deep)"],
  "top3Desires": ["Desire 1", "Desire 2", "Desire 3"],
  "topObjections": ["Objection 1", "Objection 2", "Objection 3"],
  "topTriggers": ["Trigger Event 1", "Trigger Event 2", "Trigger Event 3"],
  "wordsTheyUse": "Natural phrases they use: 'phrase 1', 'phrase 2', 'phrase 3', etc."
}`,
...
- bestIdealClient: An OBJECT with 6 fields (location, ageLifeStage, roleIdentity, incomeRevenueRange, familySituation, decisionStyle)
- top3Challenges: ARRAY of 3 specific pain points
- top3Desires: ARRAY of 3 desires/goals
- topObjections: ARRAY of 3 objections they might have
- topTriggers: ARRAY of 3 trigger events that make them buy
- wordsTheyUse: STRING with natural phrases

REFINEMENT GUIDELINES:
- ENHANCE the existing content within the SAME field structure
- DO NOT restructure or rename any fields
- Keep all arrays at their current lengths
...

{
  ...
  "salesPage": {
    ...
    "audience_callout_for_1": "✓ Qualifying characteristic 1",
    ...
    "audience_callout_not_1": "✗ Disqualifying characteristic 1",
    ...
    "call_expectations_is_for_bullet_1": "✓ Call purpose 1",
    "call_expectations_is_for_bullet_2": "✓ Call purpose 2",
    "call_expectations_is_for_bullet_3": "✓ Call purpose 3",
    "call_expectations_not_for_headline": "This Call is NOT...",
    "call_expectations_not_for_bullet_1": "✗ What call is NOT 1",
...
- optinPage: 4 fields (headline_text, subheadline_text, cta_button_text, mockup_image)
