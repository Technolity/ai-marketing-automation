...
OUTPUT SCHEMA:
{
  "appointmentReminders": {
    ...
    "smsReminders": {
      "reminder1Day": "<Short SMS text under 160 chars>",
      "reminder1Hour": "<Short SMS text under 160 chars>",
      "reminderNow": "<Short SMS text under 160 chars>"
    }
  }
}`,

    refinementContext: `REFINEMENT GUIDELINES:
- Must have EXACTLY 3 contentTips, 3 keyBenefits, 3 preparationSteps
...
- Emails array must include: Confirmation, 24-Hour Reminder, 1-Hour Reminder, Starting Now, No-Show Follow-up
- Each email must have: name, timing, subject, preheader, body
- smsReminders must include reminder1Day, reminder1Hour, reminderNow`
  },
