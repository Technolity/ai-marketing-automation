...
OUTPUT MUST MATCH THIS EXACT SCHEMA:
{
  ...
  "networkingStory": "📍 Use for: Networking events, podcasts, casual conversations. 60-90s fast conversational story. Write as flowing text (NO markdown bold headers, NO asterisks). 1-2 sentences per phase. Ends: 'Now I help [Client] [Outcome] using [Method]'",
...
- Keep coffee-talk tone throughout
- NO markdown formatting anywhere (no **bold**, no _italic_, no # headers, no asterisks) — plain text only`
  },
...
- tier1Promise, tier1Timeframe, tier1Deliverables, tier1RecommendedPrice
- tier2Promise, tier2Timeframe, tier2Deliverables, tier2RecommendedPrice
...
- NO placeholders, only specific content`
  ...
  vslShort: {
    originalGenerationPrompt: `You are an expert VSL (Video Sales Letter) scriptwriter specializing in short-form appointment booking videos.

Generate a SHORT-FORM Video Sales Letter script optimized for appointment booking (5-7 minutes).
Uses the Ted McGrath 16-section framework to drive booked calls.
...
OUTPUT MUST MATCH THIS EXACT FLAT SCHEMA (all 16 fields at root level):
{
  "patternInterruptHook": "Bold statement that breaks a belief. 2-3 sentences. (0–15s)",
  "identifyAudience": "Clearly state who this video is for. 2-3 sentences. (15–25s)",
  "amplifyCorePain": "Describe their frustrations vividly. 3-4 sentences. (25–45s)",
  "introduceEnemy": "Externalize the problem. Broken system, not them. 2-3 sentences. (45–60s)",
  "revealHiddenTruth": "The epiphany moment — real reason they struggle. 2-3 sentences. (60–75s)",
  "earlyCTA": "Capture fast decision-makers. 1-2 sentences. (~75s)",
  "authorityStory": "Why listen to you? Build trust. 4-6 sentences. (75–120s)",
  "namedFramework": "Introduce branded framework. 3 pillars. 3-4 sentences. (120–150s)",
  "insightOne": "First key insight → Case study → Outcome. 4-5 sentences.",
  "insightTwo": "Second insight → Case study → Outcome. 4-5 sentences.",
  "insightThree": "Third insight → Transformation → Outcome. 4-5 sentences.",
  "microCommitment": "Ask viewer to mentally agree. 2-3 sentences.",
  "futurePace": "Paint the desired future. 3-4 sentences. (300–330s)",
  "objectionHandling": "Address 3-4 common doubts. 5-7 sentences. (330–390s)",
  "riskReversal": "Reduce fear + explain what happens on call. 4-6 sentences. (390–450s)",
  "finalCTA": "Clear, confident closing call to action. 2-3 sentences."
}`,

    refinementContext: `CRITICAL: PRESERVE THE EXACT SAME FLAT SCHEMA STRUCTURE AS THE ORIGINAL.

The Short Form VSL uses a FLAT structure with 16 fields at root level. DO NOT nest in wrappers.

Key fields that MUST remain as-is:
- patternInterruptHook, identifyAudience, amplifyCorePain, introduceEnemy, revealHiddenTruth
- earlyCTA, authorityStory, namedFramework
- insightOne, insightTwo, insightThree
- microCommitment, futurePace, objectionHandling, riskReversal, finalCTA

REFINEMENT GUIDELINES:
- ENHANCE content within the SAME flat field structure
- DO NOT restructure or wrap in nested objects
- Keep 100% conversational, direct-to-camera tone
- Each field should be complete, standalone spoken script
- NO placeholders, only specific content
- This is a 5-7 minute video — keep each section tight and punchy
- Multiple CTAs (early, middle implied in micro-commitment, final) are critical for conversion`
  },
...
**CRITICAL: Format all email BODY fields using proper HTML tags:**
...
• Use <a href="[BOOKING_LINK]" target="_blank">link text</a> for the call booking link
...
• Subject and preview fields should be PLAIN TEXT (no HTML)

Use {{contact.first_name}} for personalization. Use [BOOKING_LINK] for booking.

OUTPUT SCHEMA (flat keys, NOT an array):
{
  "emailSequence": {
    "email1": {"subject": "Your [Free Gift Name] is Here 🎁", "preview": "Thanks for requesting...", "body": "<p>Hey {{contact.first_name}},</p><p><strong>Opening line.</strong></p><p>Body paragraph...</p>"},
    "email2": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email3": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email4": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email5": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email6": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email7": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML body>"},
    "email8a": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 250-400 word HTML CLOSING DAY 1 MORNING>"},
    "email8b": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML CLOSING DAY 1 AFTERNOON>"},
    "email8c": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 200-350 word HTML CLOSING DAY 1 EVENING>"},
    "email9": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email10": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email11": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email12": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email13": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email14": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 350-550 word HTML body>"},
    "email15a": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 300-500 word HTML CLOSING DAY 2 MORNING>"},
    "email15b": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 400-600 word HTML CLOSING DAY 2 AFTERNOON>"},
    "email15c": {"subject": "<Subject>", "preview": "<Preview>", "body": "<COMPLETE 400-600 word HTML CLOSING DAY 2 EVENING>"}
  }
}`,
...
⚠️ HTML FORMATTING IS MANDATORY FOR EMAIL BODIES:
- ALL email body fields MUST use proper HTML tags: <p>, <strong>, <ul>, <ol>, <li>, <a>
- Wrap every paragraph in <p></p> tags
- Use <strong> for emphasis (NEVER markdown ** or bold)
- Use <a href="[BOOKING_LINK]" target="_blank">Book your call</a> for CTAs
- Subject and preview fields must remain PLAIN TEXT (no HTML)
- NO markdown formatting anywhere in the body - HTML tags ONLY
- If the original content uses HTML, you MUST preserve and maintain that HTML formatting
- NEVER strip HTML tags from email bodies during refinement`
  },
...
• Structure: Story hook → Problem → What they've tried → Discovery → Solution → 3 benefits → Social proof → Inspirational CTA
• NO emojis in long ad
...
OUTPUT SCHEMA (flat keys, NOT an array):
{
  "facebookAds": {
    ...
    "shortAd1PrimaryText": "<COMPLETE 100-150 word ad following TED SHORT-FORM FRAMEWORK: Hook → Problem+Pain → Authority → Unique Mechanism → Qualification → CTA → Optional P.S. Emojis REQUIRED. No bullets, no labels.>",
    ...
    "longAdPrimaryText": "<COMPLETE 250-350 word LONG-FORM ad: Story hook → Problem → What they've tried → Your discovery → Solution → 3 benefits → Social proof → Inspirational CTA. Full structure, no labels, no bullets. NO emojis.>",
...
SHORT ADS (shortAd1 & shortAd2) — TED SHORT-FORM FRAMEWORK:
- 100-150 words each
- Emojis REQUIRED (natural usage)
- Hook MUST include timeframe + ease + desire/problem
- Structure: Hook → Problem+Pain → Authority → Unique Mechanism → Qualification → CTA → Optional P.S.
- No bullets, no section labels in output
- Copy must feel fast, punchy, and scroll-stopping
- Cold-traffic friendly, outcome > features

LONG AD (longAd) — UNCHANGED LONG-FORM FRAMEWORK:
- 250-350 words
- NO emojis
- Full story-driven structure with social proof
...
Generate complete, ready-to-use funnel page copy using the 80-field text-only structure (03_* GHL custom values).

CRITICAL REQUIREMENTS:
✅ ALL 80 fields must be filled - NO empty fields allowed
...

{
  "optinPage": {
    ...
    "footer_text": "Copyrighted By \\"${'{businessName}'}\\" 2026 |Terms & Conditions"
  },
  "salesPage": {
    ...
    "bio_paragraph_text": "Brief bio (Max 300 words, NO paragraph breaks — write as a single continuous block of text with no line breaks or paragraph separations, avoid dashes) - Focus entirely on who the founder is, their story, and what they offer.",

    // === TESTIMONIALS (10 fields) ===
  ...
  "calendarPage": {
    "headline": "Calendar page headline (max 150 chars)",
    "calendar_embedded_code": "",
    "footer_text": "Copyrighted By \\"${'{businessName}'}\\" 2026 |Terms & Conditions"
  },
  "thankYouPage": {
    "headline": "Thank you headline (max 150 chars)",
    "subheadline": "Thank you subheadline (max 300 chars)",
    "footer_text": "Copyrighted By \\"${'{businessName}'}\\" 2026 |Terms & Conditions"
  }
}

IMPORTANT RULES:
• ALL 80 fields MUST have content (calendar_embedded_code can remain empty)
...
• Make FAQ questions address realistic objections from the ideal client profile
• NO placeholders - write complete, specific, ready-to-use copy`,

    refinementContext: `REFINEMENT GUIDELINES FOR 80-FIELD STRUCTURE:
- optinPage: 5 fields (headline_text, subheadline_text, cta_button_text, popup_form_headline, footer_text)
- salesPage: 69 fields organized into 10 sections (Hero, Process, How It Works, Audience, Call Expectations, Bio, Testimonials, FAQ, Final CTA, Footer)
- calendarPage: 3 fields (headline, calendar_embedded_code, footer_text)
- thankYouPage: 3 fields (headline, subheadline, footer_text)
...
Write ACTUAL appointment reminder emails and SMS for a real business - sent through GoHighLevel to ensure leads attend calls.

CRITICAL: NO placeholders except {{custom_values.video_link}}, [BOOKING_LINK], {{custom_values.session_link}}. Use {{contact.first_name}} for personalization.

FORMATTING REQUIREMENTS (HTML):
- Wrap each paragraph in <p></p> tags
- Use <strong></strong> for emphasis (not **)
- Use <ul><li></li></ul> for bulleted lists
- Use <ol><li></li></ol> for numbered lists
- Use <a href="[BOOKING_LINK]" target="_blank">link text</a> for booking/reschedule links
- Use <a href="{{custom_values.session_link}}" target="_blank">link text</a> for session/call join links
- NO markdown formatting
- Each paragraph should be wrapped in <p></p> tags with line breaks between them

OUTPUT SCHEMA (named keys, NOT an array):
{
  "appointmentReminders": {
    "contentTips": {
    ...
    "smsReminders": {
      "confirmationSms": {"timing": "Immediately upon booking", "message": "<SMS under 300 chars>"},
      "reminder48HoursSms": {"timing": "48 hours before", "message": "<SMS under 300 chars>"},
      "reminder24HoursSms": {"timing": "24 hours before", "message": "<SMS under 300 chars>"},
      "reminder1HourSms": {"timing": "1 hour before", "message": "<SMS under 300 chars>"},
      "reminder10MinSms": {"timing": "10 minutes before", "message": "<SMS under 300 chars>"},
      "startingNowSms": {"timing": "At appointment time", "message": "<SMS under 300 chars>"}
    }
  }
}`,
...
- Email bodies must be COMPLETE and HTML-formatted (no markdown)
- Use {{contact.first_name}} for personalization
- Use {{custom_values.video_link}}, [BOOKING_LINK], {{custom_values.session_link}} for dynamic links
- NO other placeholders allowed
- Emails use NAMED KEYS (not array): confirmationEmail, reminder48Hours, reminder24Hours, reminder1Hour, reminder10Minutes, startingNow, noShowFollowUp
- Each email must have: timing, subject, previewText, body
- smsReminders must include: confirmationSms, reminder48HoursSms, reminder24HoursSms, reminder1HourSms, reminder10MinSms, startingNowSms
- Each SMS must have: timing, message (under 300 chars)`
  },
...
- NO placeholders like "[insert]" or "TBD"`
  ...
  sms: {
    originalGenerationPrompt: `You are generating a 15-day SMS nurture sequence to complement the email sequence. These are short, punchy text messages.
...
{
  "smsSequence": {
    "sms1": { "timing": "Day 1 - Immediately", "message": "[Under 160 chars]" },
    "sms2": { "timing": "Day 2", "message": "[Under 160 chars]" },
    "sms3": { "timing": "Day 3", "message": "[Under 160 chars]" },
    "sms4": { "timing": "Day 4", "message": "[Under 160 chars]" },
    "sms5": { "timing": "Day 5", "message": "[Under 160 chars]" },
    "sms6": { "timing": "Day 6", "message": "[Under 160 chars]" },
    "sms7a": { "timing": "Day 7 - Morning", "message": "[Under 160 chars]" },
    "sms7b": { "timing": "Day 7 - Evening", "message": "[Under 160 chars]" },
    "sms8a": { "timing": "Day 8 - Morning", "message": "[Under 160 chars]" },
    "sms8b": { "timing": "Day 8 - Afternoon", "message": "[Under 160 chars]" },
    "sms8c": { "timing": "Day 8 - Evening", "message": "[Under 160 chars]" },
    "sms9": { "timing": "Day 9", "message": "[Under 160 chars]" },
    "sms10": { "timing": "Day 10", "message": "[Under 160 chars]" },
    "sms11": { "timing": "Day 11", "message": "[Under 160 chars]" },
    "sms12": { "timing": "Day 12", "message": "[Under 160 chars]" },
    "sms13": { "timing": "Day 13", "message": "[Under 160 chars]" },
    "sms14": { "timing": "Day 14", "message": "[Under 160 chars]" },
    "sms15a": { "timing": "Day 15 - Morning", "message": "[Under 160 chars]" },
    "sms15b": { "timing": "Day 15 - Afternoon", "message": "[Under 160 chars]" },
    "sms15c": { "timing": "Day 15 - Evening", "message": "[Under 160 chars]" },
    "smsNoShow1": { "timing": "Post No-Show - 30 min after", "message": "[Under 160 chars]" },
    "smsNoShow2": { "timing": "Post No-Show - Next day", "message": "[Under 160 chars]" }
  }
}`,
    refinementContext: `REFINEMENT GUIDELINES:
- Must have EXACTLY 23 SMS messages with flat keys: sms1-6, sms7a/b, sms8a/b/c, sms9-14, sms15a/15b/15c, smsNoShow1/2
- Each SMS is an object with timing and message keys
- Each message MUST be under 160 characters
- Use {{contact.first_name}} and [BOOKING_LINK]
- Keep it human and conversational
- Keep the exact schema keys (never use underscores like sms_8a)`
  }
};
