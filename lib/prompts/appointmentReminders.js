...
Generate JSON (no markdown):
{
  "appointmentReminders": {
    ...
    "noShowFollowUp": {
      ...
      "previewText": "Plain text preview (no HTML)",
      "body": "<p>Hey {{contact.first_name}},</p>\\n\\n<p>Complete 100-150 word HTML-formatted caring follow-up with reschedule link using <strong><a href=\\"[BOOKING_LINK]\\" target=\\"_blank\\">Reschedule here</a></strong></p>"
    },
    "smsReminders": {
