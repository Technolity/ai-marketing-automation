...
JSON OUTPUT (no markdown):
{
  "signatureOffer": {
    ...
    "pricingStrategy": {
      "recommendedPrice": "$5,000-$10,000 (adjust based on niche)",
      "rationale": "Why this price point works for this offer/market",
      "ascensionPath": "Next step after this offer (e.g., Year-long Mastermind)"
    },
    "cta": "Primary CTA"
  }
}
