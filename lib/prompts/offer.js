...
**TIER 1 - 90-DAY SIGNATURE OFFER ($5K-$10K):**
The recommended structure is a group coaching program for 8-10 weeks followed by:
- A 1 or 2 day virtual training event
- Optional: 3-5 private coaching sessions to increase value
- If this is a service business, use the blueprint as a way to pitch current offer better
  and give the customer a step-by-step experience
- The 7-step blueprint should be delivered with the FIRST 3 STEPS covered in-depth during Tier 1

**TIER 2 - YEAR-LONG PROGRAM ($15K-$75K):**
The recommended structure is private coaching with a combination of:
- 3 two-day events/masterminds throughout the year
- OR just private coaching alone
- This is the $25K to $75K program or service delivery
- The year-long program should cover steps 4-7 of the blueprint
- The more times you go over something with someone, the more confident they get
...

{
  ...
  "tier2Deliverables": "Private coaching with 3 two-day events/masterminds throughout the year, advanced training, priority support",
  "tier2RecommendedPrice": "$25,000-$75,000",
  "offerPromise": "In Tier 1, I help [Ideal Client] go from [problem] to [outcome] using [system] — without [tradeoff].\\n\\nIn Tier 2, I help [Ideal Client] go from [problem] to [outcome] using [system] — without [tradeoff]."
}
...
• IMPORTANT: stepName should contain ONLY the step name (e.g., "Vitality Audit Baseline"), NOT "Step 1 — Vitality Audit Baseline". The step number is implicit in the array order.
