...
export async function POST(req) {
  try {
    ...
    console.log('[Facebook POST] Received body:', { caption: !!caption, imageUrl: !!imageUrl, daily_post_id });

    if (!caption || !imageUrl) {
      console.error('[Facebook POST] Missing fields:', { caption: caption?.slice(0, 20), imageUrl });
