...
export async function POST(req) {
  try {
    ...
    console.log('[X POST] Received body:', { caption: !!caption, imageUrl: !!imageUrl, daily_post_id });

    if (!caption || !imageUrl) {
      console.error('[X POST] Missing fields:', { caption: caption?.slice(0, 20), imageUrl });
